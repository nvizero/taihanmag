class MsgsController < ApplicationController
  ...
  # GET /msgs.json
  def index
    @msgs = Msg.where.not(cate_id: [1]) .order(sort_column + " " + sort_direction).page(params[:page]).limit(12)
  end
